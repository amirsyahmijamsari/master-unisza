...
## 5.3 Objective 2: Distribution Selection
...
**Table 5.5: Return Values (mm) for Annual Maximum Series**
...
**Table 5.5b: Return Values (mm) for Daily Rainfall Series**
...
**Figure 5.6:** Heatmap of Return Values by Station and Return Period.

**Key Findings:**
- **Annual Maximum Series**: 100-year return values range from 365.5 mm to 1124.9 mm
- **Daily Rainfall Series**: 100-year return values range from 129.9 mm to 169.3 mm
- The daily series return values are significantly lower than annual maxima, reflecting the different frequency contexts
- All daily series use the Kappa distribution, providing consistent modeling across stations
- Coastal stations show higher return values in both series
...
**Table 5.6: Overestimation Analysis at 99th Percentile**
